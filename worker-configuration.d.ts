/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 38995091dac0dbd131bbe83ba9fa9764)
// Runtime types generated with workerd@1.20260917.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMIT: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	STUDENT_EMAIL_DOMAIN: "std.cu.ac.bd";
	MASTER_KEY: string;
	TERM_PEPPER: string;
	GOOGLE_CLIENT_ID: string;
	ALLOW_DEV_LOGIN: string;
	NEXT_PUBLIC_ALLOW_DEV_LOGIN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STUDENT_EMAIL_DOMAIN" | "MASTER_KEY" | "TERM_PEPPER" | "GOOGLE_CLIENT_ID" | "ALLOW_DEV_LOGIN" | "NEXT_PUBLIC_ALLOW_DEV_LOGIN">> {}
}
